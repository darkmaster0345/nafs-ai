#!/usr/bin/env python3
"""
Nafs AI — Standalone Runner for Eve
========================================
Runs Eve's brain WITHOUT the rest of the project.
Just needs: nafs_brain.py + eve.pt in the same folder, and torch.

Usage:
    python run_eve.py                  # random sensory test
    python run_eve.py 0.5 0.2 0.0 ...  # pass a 21-dim sensory vector
    python run_eve.py --interactive    # interactive REPL, type sensory vecs
"""
import os, sys, math, random
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from nafs_brain import load_agent, think, ACTION_NAMES

CKPT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "eve.pt")
...
def main():
    ...
    print("=" * 60)
    print(f"  Nafs AI — {meta.get('agent','Eve')} (standalone)")
    print("=" * 60)
